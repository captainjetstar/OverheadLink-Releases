...
def build(base_executable: Path, project: Path, output: Path) -> None:
    ...
    required = {
        ...
        "firmware/precompiled/mega/OverheadLinkMega.ino.hex",
        "firmware/precompiled/nano/OverheadLinkBacklightNano.ino.hex",
        "vendor/avrdude/bin/avrdude.exe",
        "vendor/avrdude/etc/avrdude.conf",
        "vendor/python-3.12.10-amd64.exe",
        "vendor/pyserial-3.5-py2.py3-none-any.whl",
        "vendor/SimConnect.dll",
    }

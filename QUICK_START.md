...
1. Double-click `OverheadLink_v0.3.4_Windows_x64.exe`. Its first run installs the embedded private runtime, USB serial support, and SimConnect client automatically, then creates an **OverheadLink** desktop shortcut.
